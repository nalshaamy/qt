...
## 19.0.3.0.6
- Fixed registered-customer Self Order creation under portal sessions.
- Fixed customer tracking progress rendering.
- Improved order creation logging and disabled unnecessary mail tracking during public checkout.
