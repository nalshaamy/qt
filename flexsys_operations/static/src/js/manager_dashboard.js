...
function renderMissionControl(data) {
    ...
    if (healthLabel) {
        healthLabel.textContent = health >= 90 ? "ممتاز" : health >= 70 ? "مستقر" : health >= 50 ? "يحتاج متابعة" : "حالة حرجة";
    ...
    const eventLabels = {
        ...
        "order.state_changed": "تغيرت حالة طلب",
        "order_line.state_changed": "تغيرت حالة صنف",
        "task.created": "تم إنشاء مهمة تنفيذ",
    };
