...
class FlexSysKdsController(http.Controller):
    ...
    @http.route('/flexsys_kds/stations', type='json', auth='user')
    ...
    @http.route('/flexsys_kds/orders', type='json', auth='user')
    ...
    @http.route('/flexsys_kds/line/action', type='json', auth='user')
    ...
    @http.route('/flexsys_kds/order/action', type='json', auth='user')
    ...
    @http.route('/flexsys_kds/print/reprint', type='json', auth='user')
...
class FlexSysKdsPrintAgentController(http.Controller):
    ...
    @http.route('/flexsys_kds/print/agent/claim', type='json', auth='none', csrf=False)
    ...
    @http.route('/flexsys_kds/print/agent/ack', type='json', auth='none', csrf=False)
    ...
    @http.route('/flexsys_kds/print/agent/result', type='json', auth='none', csrf=False)
